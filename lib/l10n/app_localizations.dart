...
import 'app_localizations_quz.dart';
...
abstract class AppLocalizations {
  ...
  /// No description provided for @spanishTranslation.
  ///
  /// In es, this message translates to:
  ...
  /// No description provided for @generateTranslation.
  ///
  /// In es, this message translates to:
  /// **'Generar traducción con IA'**
  String get generateTranslation;
}
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      <String>['en', 'es', 'quz'].contains(locale.languageCode);
